...
self.addEventListener('fetch',event=>{
  ...
  if(url.pathname.endsWith('/billing-live.js')||url.pathname.endsWith('/provider-market.js')||url.pathname.endsWith('/diy-assistant.js')||url.pathname.endsWith('/diy-assistant.css')||url.pathname.endsWith('/style.css')||url.pathname.endsWith('/other-problem.js')){
